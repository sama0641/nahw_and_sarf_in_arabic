...
public class MeemGerundConjugator implements IUnaugmentedTrilateralGerundConjugator {
    ...
    private MeemGerundConjugator() {
        symbolToFormulaNameMap.put("C","���������");
        symbolToFormulaNameMap.put("D","���������");
        symbolToFormulaNameMap.put("E","���������");

        formulaNameToSymbolMap.put("���������", "C");
        formulaNameToSymbolMap.put("���������", "D");
        formulaNameToSymbolMap.put("���������", "E");
    }
    ...
    public List createGerundList(UnaugmentedTrilateralRoot root, String formulaName) {
        ...
        if (formulaName.equals("�������") || formulaName.equals("�������")) {
