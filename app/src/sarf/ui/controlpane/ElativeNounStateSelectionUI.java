...
public class ElativeNounStateSelectionUI extends JPanel implements INounStateSelectionUI{
    ...
    ToggleRenderedButton annexedDefiniteBtn = new ToggleRenderedButton("������ ��� �����  ");
    ToggleRenderedButton annexedIndefiniteBtn = new ToggleRenderedButton("������ ��� ����  ");
    ToggleRenderedButton notAnnexedIndefiniteBtn = new ToggleRenderedButton("��� ������ ");
