...
public class TrilateralUnaugmentedGerundsUI extends JPanel implements IControlPane {
    ...
    public void setInfo(SelectionInfo selectionInfo) {
        ...
        if (standardGerundsSymbols != null && !standardGerundsSymbols.isEmpty()) {
            controlPanels.add("������ ������ ", createControlPanel(TrilateralUnaugmentedGerundConjugator.getInstance(), UnaugmentedTrilateralStandardGerundModifier.getInstance(), StandardTrilateralUnaugmentedSuffixContainer.getInstance(), "������ ������"));
        }

        controlPanels.add("������ ������ ", createControlPanel(MeemGerundConjugator.getInstance(), TitlateralUnaugmentedMeemModifier.getInstance(), GenericNounSuffixContainer.getInstance(), "������ ������"));

        controlPanels.add("���� ����� ", createControlPanel(TrilateralUnaugmentedNomenGerundConjugator.getInstance(), TitlateralUnaugmentedNomenModifier.getInstance(), GenericNounSuffixContainer.getInstance(), "���� �����"));

        controlPanels.add("���� ������ ", qualityPane);
        qualityPane.removeAll();
        AbstractButton btn = createButton("�������", QualityGerundConjugator.getInstance(), TitlateralUnaugmentedQualityModifier.getInstance(), GenericNounSuffixContainer.getInstance(), "���� ������");
        qualityPane.add(btn);
