...
public class TrilateralUnaugmentedNounsUI extends JPanel implements IControlPane {
    ...
    public void setInfo(SelectionInfo selectionInfo) {
        ...
        JToggleButton activeParticipleBtn = createButton("������", UnaugmentedTrilateralActiveParticipleConjugator.getInstance(), ActiveParticipleModifier.getInstance(), "��� ������");
        activeParticiplePane.add(activeParticipleBtn);
        activeParticipleBtn.doClick();

        controlPanels.add("��� ������� ", passiveParticiplePane);
        passiveParticiplePane.removeAll();
        passiveParticiplePane.add(createButton("��������", UnaugmentedTrilateralPassiveParticipleConjugator.getInstance(), PassiveParticipleModifier.getInstance(), "��� �������"));
        ...
        if (nounsObject.getTimeAndPlaces() != null && !nounsObject.getTimeAndPlaces().isEmpty()) {
            controlPanels.add("���� ������ �������  ", createControlPanel(sarf.noun.trilateral.unaugmented.timeandplace.TimeAndPlaceConjugator.getInstance(), TimeAndPlaceModifier.getInstance(), "��� ������ �������"));
        }


        if (nounsObject.getElatives() != null && !nounsObject.getElatives().isEmpty()) {
            controlPanels.add("��� ������� ", createElativeControlPanel(sarf.noun.trilateral.unaugmented.elative.ElativeNounConjugator.getInstance(), ElativeModifier.getInstance(), ElativeSuffixContainer.getInstance(), "��� ������� "));
        }

        if (nounsObject.getAssimilates() != null && !nounsObject.getAssimilates().isEmpty()) {
            controlPanels.add("����� ������� ", createAssimilateControlPanel(sarf.noun.trilateral.unaugmented.assimilate.AssimilateAdjectiveConjugator.getInstance(), AssimilateModifier.getInstance(), "����� �������"));
        }
