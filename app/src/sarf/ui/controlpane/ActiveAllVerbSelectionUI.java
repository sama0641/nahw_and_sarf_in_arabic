...
public class ActiveAllVerbSelectionUI extends JPanel implements IControlPane, AugmentedTrilateralModifierListener {
    ...
    ToggleRenderedButton allBtn = new ToggleRenderedButton("����");
    ToggleRenderedButton pastBtn = new ToggleRenderedButton("������");
    
    ToggleRenderedButton presentNominativeBtn = new ToggleRenderedButton("������� �������");
    ToggleRenderedButton presentAccusativeBtn = new ToggleRenderedButton("������� �������");
    ToggleRenderedButton presentJussiveBtn = new ToggleRenderedButton("������� �������");
    ToggleRenderedButton presentEmphasizedBtn = new ToggleRenderedButton("������� ������");
    ToggleRenderedButton imperativeBtn = new ToggleRenderedButton("�����");
    ToggleRenderedButton imperativeEmphasizedBtn = new ToggleRenderedButton("����� ������");
    ...
    public ActiveAllVerbSelectionUI() {
        ...
        // passive
        ToggleRenderedButton passivePastBtn = new ToggleRenderedButton("������ ������� ");
        ToggleRenderedButton passivePresentNominativeBtn = new ToggleRenderedButton("������� ������� ������� ");
        ToggleRenderedButton passivePresentAccusativeBtn = new ToggleRenderedButton("������� ������� ������� ");
        ToggleRenderedButton passivePresentJussiveBtn = new ToggleRenderedButton("������� ������� ������� ");
        ToggleRenderedButton passivePresentEmphasizedBtn = new ToggleRenderedButton("������� ������ ������� ");
        ...
        allBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	...
            	AllVerbConjugationUI ui = new AllVerbConjugationUI(result, "������");
